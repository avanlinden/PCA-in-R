...
The first step is to install the tidyverse packages if you haven't already, and then load the library. Tidyverse contains a lot of useful packages, including dplyr and ggplot2, which we will use here. We'll also load the ggrepel library to help with label positioning in our plots later.
...
I often find it useful to add colors and labels for both exploratory visualization of my PC data and later publication-quality figures. Here is a morphospace where the points are colored by fighting style:

...
Load the ruminant vertebral morphology data set (you can find it ) and format it as a tibble (a tibble is dplyr's version of a dataframe), then take a look at it.
